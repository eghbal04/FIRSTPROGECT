...
یک پلتفرم پیشرفته Web3 برای توکن LevelUp با قابلیت‌های متنوع و رابط کاربری مدرن.
...
### 🔗 اتصال کیف پول
- **اتصال هوشمند**: پلتفرم به طور خودکار بهترین روش اتصال را انتخاب می‌کند
- **MetaMask**: پشتیبانی کامل از MetaMask
- **QR Code**: اتصال بدون نیاز به افزونه مرورگر با استفاده از بارکد
- **WalletConnect**: پشتیبانی از کیف پول‌های موبایل

### 📱 اتصال با بارکد (QR Code)
یکی از ویژگی‌های منحصر به فرد این پلتفرم، امکان اتصال به کیف پول بدون نیاز به افزونه مرورگر است:

#### نحوه استفاده:
1. روی دکمه **"📱 اتصال با بارکد"** کلیک کنید
2. یک بارکد روی صفحه نمایش داده می‌شود
3. با کیف پول موبایل خود (مثل MetaMask Mobile، Trust Wallet، یا هر کیف پول سازگار با WalletConnect) بارکد را اسکن کنید
4. اتصال به طور خودکار برقرار می‌شود

#### مزایا:
- ✅ بدون نیاز به افزونه مرورگر
- ✅ سازگار با تمام کیف پول‌های موبایل
- ✅ امنیت بالا
- ✅ استفاده آسان
...
### 🔐 پنل ادمین
- **پنل Owner**: مدیریت مالکیت قرارداد
- **مدیریت پراپ‌ها**: افزودن/ویرایش/حذف پراپ‌ها
- **مدیریت ساب ادمین**: کنترل دسترسی‌ها و نقش‌ها

### 📊 چارت‌های دوگانه
- **چارت قیمت توکن**: نمایش قیمت CPA
- **چارت ارزش پوینت**: نمایش ارزش پوینت‌ها
- **کنترل‌های مستقل**: هر چارت کنترل‌های جداگانه دارد

### 🎨 بهبودهای UI/UX
- **منوی همبرگری مدرن**: طراحی glass effect
