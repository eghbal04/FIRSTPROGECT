# سیستم چارت‌های جداگانه CPA Terminal

## 📊 بررسی کلی

سیستم چارت‌های جداگانه برای نمایش تاریخچه قیمت‌های توکن CPA و پوینت‌ها به صورت مستقل طراحی شده است. هر چارت دارای کنترل‌های جداگانه و نمایش مستقل است.

## 🏗️ ساختار فایل‌ها

### `js/price-chart.js`
کلاس چارت قیمت توکن CPA:
```javascript
class PriceChart {
