...
const localNews = [
    {
        id: 'platform-3',
        title: '💱 نحوه خرید و فروش توکن IAM',
        content: 'آموزش کامل نحوه سواپ توکن IAM با MATIC و مدیریت موجودی کیف پول. شامل محاسبه کارمزدها و بهترین زمان‌ها برای معامله.',
        url: '#',
        image: 'https://via.placeholder.com/300x200/232946/00ccff?text=Token+Swap',
        category: 'trading',
        date: new Date('2025-01-13'),
        source: 'LevelUp Team',
        tags: ['خرید', 'فروش', 'سواپ', 'IAM']
    }
];
